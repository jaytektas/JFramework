...
def main() -> None:
    ...
    lines: list[str] = [
        # The generated header is checked in, so it carries the same licence banner every other
        # source file does — emitted here, or the next build strips it back off again.
